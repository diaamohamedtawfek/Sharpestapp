 ...
 */
public class Show_Machine_Fragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener {

    public Show_Machine_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_show__myoder, container, false);
    ...
    private void getjson(final int i) {
        ...
        if (conMgr.getActiveNetworkInfo() != null && conMgr.getActiveNetworkInfo().isAvailable() && conMgr.getActiveNetworkInfo().isConnected()) {
            ...
            final StringRequest stringRequest = new StringRequest(Request.Method.GET,
                    Urls.machen_myrequest+i+"&size=10",
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {

                            Log.e("url>>>>>>>>machine ",REGISTER_URL+"  "+response);
...
//                                Toast.makeText(getActivity(), "Fi nal", Toast.LENGTH_LONG).show();
                                //TODO
