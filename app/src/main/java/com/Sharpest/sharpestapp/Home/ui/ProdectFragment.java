 ...
 *  //الماكينات
 */
public class ProdectFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_prodect, container, false);
    ...
    private void getjson(final int i) {
        ...
        if (conMgr.getActiveNetworkInfo() != null && conMgr.getActiveNetworkInfo().isAvailable() && conMgr.getActiveNetworkInfo().isConnected()) {
            ...
            final StringRequest stringRequest = new StringRequest(Request.Method.GET,
                    Urls.productMulti_list +i+"&size=10&sparePartsFlag=0",
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {

                            Log.e("الماكينات url>>>>>>>> ",REGISTER_URL+"  "+response);
                            if (response.length() > 0) {
                                ...
                                dataDelevery = gson.fromJson(response, DataHomeListInList.class);
