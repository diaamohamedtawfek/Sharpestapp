...
public class DataOfers_Fainal {
     ...
     * @param offerValue
     */
    public DataOfers_Fainal(Integer id, String offerExpireDate, Integer offerActiveFlag, String offerImagePath,
                            String offerValue, Item item, Course course, ServiceRequestType serviceRequestType, List<Object> serviceRequestHeaderList) {
        super();
        this.id = id;
