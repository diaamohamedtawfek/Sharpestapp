...
import com.Sharpest.sharpestapp.Home.uiFragment.adaptor_fragment_myprder.Coursses_Myorder_ViewHolder;
import com.Sharpest.sharpestapp.Home.uiFragment.model.corceMyorder.DataCuorceFrgmentRequest;
 ...
 */
public class Show_CoursesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    public Show_CoursesFragment() {
    ...
    private Coursses_Myorder_ViewHolder recyclerView_dAdapter;
    public List<DataCuorceFrgmentRequestFinal> listItems = new ArrayList<>();
...
//        return inflater.inflate(R.layout.fragment_show__courses, container, false);
        view = inflater.inflate(R.layout.fragment_show__courses, container, false);
        // SwipeRefreshLayout
        ...
        mSwipeRefreshLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("refrech cource myorder",REGISTER_URL+"");
                listItems.clear();
                REGISTER_URL=0;
...
//        REGISTER_URL=0;
        ...
        deirection="curce_myorder";
        recyclerView_dAdapter = new Coursses_Myorder_ViewHolder(listItems,getActivity(), getActivity(),deirection);
    ...
    private void getjson(final int i) {
        Log.e("url cource order",Urls.cource_machen_myrequest+i+"&size=10");
        ...
        if (conMgr.getActiveNetworkInfo() != null && conMgr.getActiveNetworkInfo().isAvailable() && conMgr.getActiveNetworkInfo().isConnected()) {
            ...
            final StringRequest stringRequest = new StringRequest(Request.Method.GET,
                    Urls.cource_machen_myrequest+i+"&size=10" ,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {

                            Log.e("url>CourceMyorder",REGISTER_URL+"  "+response);
                            if (response.length() > 0) {
                                mSwipeRefreshLayout.setRefreshing(false);
                                //progressDialog.dismiss();
                                try {
                                Gson gson = new Gson();
                                DataCuorceFrgmentRequest dataDelevery;
                                dataDelevery = gson.fromJson(response.toString(), DataCuorceFrgmentRequest.class);
                                ...
                                if (dataDelevery.getErrorStatus().equals(false)){
                                    ...
                                    if (lengt_for > 0) {
                                        ...
                                        for (int I = 0; I < lengt_for; I++) {
                                            listItems.add(new DataCuorceFrgmentRequestFinal(
...
//                                Toast.makeText(getActivity(), "Final", Toast.LENGTH_LONG).show();
                                //TODO
