...
public class DataCuorceFrgmentRequestFinal {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public DataCuorceFrgmentRequestFinal(Integer id, String courseNameAr, String courseNameEn, String imageBanarPath, Integer courseAvailableOnline) {
        this.id = id;
        this.courseNameAr = courseNameAr;
        this.courseNameEn = courseNameEn;
        this.imageBanarPath = imageBanarPath;
