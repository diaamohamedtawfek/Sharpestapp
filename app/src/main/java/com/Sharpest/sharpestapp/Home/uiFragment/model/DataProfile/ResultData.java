...
public class ResultData {
     ...
     * @param customer
     */
    public ResultData(Integer id, String userName, Integer userActiveFlag, Object jwt, Object employee, List<SecurityRole> securityRole, Customer customer, String profileImage, String whatsupPhoneNumber) {
        super();
        this.id = id;
