...
public class Details_CourssesActivity extends AppCompatActivity {
    ...
    public void defineUi(){
        ...
        addrequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showDialog(Details_CourssesActivity.this, "String msg");
            }
        });
        ...
        promoCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog(Details_CourssesActivity.this, "promo");
            }
        });
...
//                                recyclerView_contentCource.setLayoutManager(gridLayoutManager);
                                ...
                                recyclerView_dAdapter_DetilesCource= new DetilesCource_Course_DetlesCours_viewHolder(arrayList_detiles_course,Details_CourssesActivity.this, getApplicationContext(),"deirection");
...
//                                recyclerView_contentCource.setLayoutManager(gridLayoutManager);
                                ...
                                recyclerView_dAdapter = new ContentCourse_DetlesCours_viewHolder(arrayList_content_course,Details_CourssesActivity.this, getApplicationContext(),"deirection");
...
//                                recyclerView_contentCource.setLayoutManager(gridLayoutManager);
                                ...
                                recyclerView_learn_dAdapter = new Learn_Course_DetlesCours_viewHolder(arrayList_learn_course,Details_CourssesActivity.this, getApplicationContext(),"deirection");
...
//    }
    ...
    private void addrequestCource_Promocode(String phoneNumber, String promoCodeNumber, final EditText promocode_Dilog, final Dialog dialog){
        final ProgressDialog progressDialog=new ProgressDialog(Details_CourssesActivity.this);
        progressDialog.setMessage("Waite...");
        progressDialog.show();

        final RequestQueue requestQueue = Volley.newRequestQueue(Details_CourssesActivity.this);
        Gson gson = new Gson();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Urls.send_reqestCours_promocde
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    Log.e("---response_booking",""+dataDelevery.getErrorStatus().toString());
...
//                                Toast.LENGTH_LONG).show();
                    ...
                    Log.e("Exception booking",""+r.toString());
                }
