...
public class ContentCourse_DetlesCours_viewHolder extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private int previousPosition = 0;


    List<CourseContent> List_Item;
    private Context context;
    String deirection;
    Activity activity;

    public ContentCourse_DetlesCours_viewHolder(List<CourseContent> list_Item, Activity activity, Context context, String deirection) {
        List_Item = list_Item;
    ...
    public void filterList(ArrayList<CourseContent> filteredList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        menuItemHolder.name1.setText(""+List_Item.get(position).getCourseContentNameAr());
